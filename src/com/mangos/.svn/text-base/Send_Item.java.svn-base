...
public class Send_Item extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Header.setText("You have selected " + Character_name + " to send an item to");
    ...
    public void sendMail(){
        ...
        String item_id = split[0].trim();
        toastit(Mangos.sendItems(Character_name, split[1], "This was sent from Moble ManGOS", item_id));
        finish();
    }
    ...
    public void loadSpinner() {
        String items[] = Mangos.lookupItem(Search.getText().toString());
